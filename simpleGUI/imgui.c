...
int button(int id, double x, double y, double w, double h, char *label)
{
	...
	if( gs_button_color.fillflag ) {
		...
		drawRectangle1(x+sinkx, y+sinky, w, h, 0);
	}
...
static int menuItem(int id, double x, double y, double w, double h, char *label)
{
	...
	mySetPenColor(frameColor);
	drawBox1(x, y, w, h, gs_menu_color.fillflag, label, 'L', labelColor);
...
void drawMenuBar(double x, double y, double w, double h)
{
	...
	drawRectangle1(x,y,w,h,gs_menu_color.fillflag);
}
...
int textbox(int id, double x, double y, double w, double h, char textbuf[], int buflen)
{
	...
	// Render the text box
	mySetPenColor(frameColor);
	drawRectangle1(x, y, w, h, gs_textbox_color.fillflag);
	// show text
	mySetPenColor(labelColor);
...
void drawRectangle1(double x, double y, double w, double h, int fillflag)
{
	SetPenSize(2);
	MovePen(x, y);
	if( fillflag ) StartFilledRegion(1); 
...
void drawBox1(double x, double y, double w, double h, int fillflag, char *label, char labelAlignment, char *labelColor)
{
	double fa = GetFontAscent();
	// rect
		drawRectangle1(x,y,w,h,fillflag);
